    ...
    <ModalShell
      ...
      footer={
        <div className="flex items-center justify-end gap-3">
          <button
            onClick={onClose}
            className="rounded-2xl border border-line bg-surface-1 px-5 py-2.5 text-xs font-bold text-ink-secondary transition hover:bg-surface-2"
          >
            Отмена
          </button>
          <button
            ...
            className="rounded-2xl bg-accent-primary px-6 py-2.5 text-xs font-bold text-white transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 flex items-center gap-2 shadow-sm"
          >
    ...
    >
      <div className="space-y-4">
        ...
        <div className="grid gap-4.5 sm:grid-cols-2">
          <div>
            <label className="mb-1 block text-[10px] font-bold uppercase tracking-[0.18em] text-ink-muted">
              Название компании *
            </label>
            <input
              value={draft.name}
              ...
              className="w-full rounded-2xl border border-line bg-surface-2 px-4 py-2.5 text-xs font-semibold text-ink-primary outline-none focus:border-accent-primary focus:bg-surface-1"
            />
          </div>
