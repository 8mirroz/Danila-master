      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-mono font-bold text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
              </div>
              ...
              <div>
                <div className="flex justify-between text-xs font-bold text-slate-700 mb-1">
                  ...
                  <span className="font-mono text-slate-700">{logisticsCost.toLocaleString('ru-RU')} ₽</span>
                </div>
                <input
                  type="number"
                  value={logisticsCost || ''}
              ...
              {/* VAT Selector */}
              <div className="pt-2">
                <label className="block text-xs font-bold text-slate-700 mb-1">Режим НДС</label>
        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="rounded-3xl border border-purple-200 bg-gradient-to-br from-purple-50/80 via-white to-indigo-50/50 p-6 shadow-md space-y-5">
            ...
            <div className="rounded-2xl bg-white p-5 border border-purple-100 shadow-sm text-center space-y-2 relative overflow-hidden">
            ...
            <div className="space-y-1">
              ...
              <div className="flex h-3 w-full rounded-full overflow-hidden bg-slate-100 shadow-inner">
                {basePct > 0 && <div style={{ width: `${basePct}%` }} className="bg-slate-400 transition-all duration-300" title="Закупка"></div>}
            ...
            <div className="space-y-2 text-xs pt-2">
              <div className="flex justify-between py-1.5 border-b border-slate-100">
                <span className="text-slate-500 flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-slate-400"></span> Себестоимость:
                </span>
                <span className="font-mono font-bold text-slate-900">{baseCost.toLocaleString('ru-RU')} ₽</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-100">
                <span className="text-slate-500 flex items-center gap-2">
              ...
              <div className="flex justify-between py-1.5 border-b border-slate-100">
                ...
                <span className="font-mono text-slate-800 font-semibold">+{logisticsCost.toLocaleString('ru-RU')} ₽</span>
              </div>
